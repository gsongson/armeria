...
## 1. Update both the server and client `blog.thrift`
...
Let's implement a create method for creating a blog post.
...
Here, we've implemented a create method for creating a blog post. Next, we'll [implement a READ operation](/tutorials/thrift/blog/implement-read).
